    ...
    render() {
        return (
            <div style={{background: "rgb(102, 22, 108)", width: "100%", height: "100%", padding: "0px", margin: "0px", display: "flex", "justify-content": "center", "align-items": "center"}}>
                <div style={{background: "rgb(132, 188, 179)", padding: "20px", "border-radius": "10px"}}>
                    <img src="http://www.equalmeasures2030.org/wp-content/uploads/2017/10/em2030.jpg" style={{"text-align": "center", "max-width": "210px", height: "auto"}} />
